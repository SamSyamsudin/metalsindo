			...
			<table class="table table-bordered table-striped" width="100%">
				...
				if(!empty($data_detail)){
					...
					<tr id='tr1_<?=$idd?>' class='delAll <?=($record->id_kasbon!=''?'kasbonrow':'')?>'>
						...
						<input type="text" class="form-control input-sm" name="keterangan[]" id="keterangan_<?=$idd;?>" value="<?=$record->keterangan;?>" style='width:100px'></td>
						...
						<td data-header="Bon Bukti" width="50">
							<div class="upload-btn-wrapper">
							  ...
							  <input type="file" name="doc_file_<?=$idd?>" id="doc_file_<?=$idd?>" style="width: 90px" />
							</div>
				...
				<tfoot>
					<tr>
						...
						<td align=right colspan=2><div class="row"><div class="col-md-2">Saldo</div><div class="col-md-10"><input type="text" class="form-control divide input-sm" id="grand_total" name="grand_total" value="<?=$grand_total?>" placeholder="Grand Total" tabindex="-1" readonly style='width:90px'></div></div>
						<div class="row"><div class="col-md-2">Budget</div><div class="col-md-10"><input type="text" class="form-control divide input-sm" id="budgets" name="budgets" value="<?=$budgets?>" tabindex="-1" disabled style='width:90px'></div></div></td>
					</tr>
				</tfoot>
			</table>
			</div>
...
//			data_save();
	...
	function add_detail(){
		var Rows	 = 	"<tr id='tr1_"+nomor+"' class='delAll'>";
			...
			Rows	+= 		"</td>";
			Rows	+= 		"<td data-header='Bon Bukti'>";
			Rows	+=			"<input type='file'  name='doc_file_"+nomor+"' id='doc_file_"+nomor+"' required style='width: 90px' />";
			Rows	+= 		"</td>";
