			...
			<div class="box-body">
				...
				<div class="form-group ">
					...
					<div class='col-sm-4 col-md-4'>
						...
						echo form_dropdown('departement', $combodept, $deptid, array('id' => 'departement', 'class' => 'form-control readonly', 'tabindex' => '-1', 'style' => 'pointer-events: none;'));
						?>
					</div>
				</div>
				<div class="hidden">
				...
				<div class="box-footer">
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							if ($error_coa == '') {
								echo '<button type="submit" name="save" class="btn btn-success btn-sm" id="submit"><i class="fa fa-save">&nbsp;</i>Approve</button>';
							}
