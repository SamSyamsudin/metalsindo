...
?>
 ...
 <div class="box box-primary">
    <div class="box-body">
		...
		<tbody>
		<tr>
		<th hidden><input type='text' class='form-control'  value='<?= $tr_spk->no_surat_produksi?>' 	readonly id='no_surat' required name='no_surat'></th>
		...
		<th hidden><input type='text' class='form-control'  value='<?= $tr_spk->id_spk_aktual?>' 	readonly id='id_spk_aktual' required name='id_spk_aktual'></th>
		...
		<th><input type='text' class='form-control weight_actualpl' value='<?= $tr_spk->weight_actualpl?>'	id='weight_actualpl' onblur='hitungNGpackinglist()'required name='weight_actualpl'>
		<input type='hidden' class='form-control kg_sisa' id='kg_sisa'	value='<?= $tr_spk->kg_sisa?>'  	readonly required name='kg_sisa'>
		
		<input type='hidden' class='form-control kg_sisa_actual' 	id='kg_sisa_actual'  value='<?= $tr_spk->kg_sisa_actual?>' onkeyup='hitungActualweightproses()' required name='kg_sisa_actual'>
		</th>
		...
		<tfoot>
            ...
            <td width='7%' hidden><b></b></td>
            <td width='7%' hidden><input type='hidden' class='form-control actualweightproses' name='actualweightproses' value='<?= $tr_spk->actualweightproses?>' readonly></td>
			</tr>
		</tfoot>
		...
		<div class="col-sm-12">
			...
			foreach ($results['dt_spk'] as $dt_spk1){				
				
				
				$spkaktual= $dt_spk1->id_spk_aktual;
				$idtr     =$dt_spk1->id_tr_spk_produksi;
			
			// print_r($dt_spk2);
			// exit;	
						
			$dt =$this->db->query("SELECT a.* FROM dt_spk_aktual_detail as a  where a.id_tr_spk_produksi = '".$idtr."'")->result();
			
			
			
			foreach ($dt as $dt_spk){				
				$loop++; 
			...
			if($surat <> 'NONSPK'){
				$spkmar = $nosurat->no_surat;
								...
								<tr id='tr_$loop'>
									...
									<th>
									<input type='text' class='form-control dt_qtywidth autoNumeric'  	onblur='HitungTotalberat($loop)'	value='$dt_spk->qtysatuan' tabindex='1'	 id='used_qtywidth_$loop' required name='dt[$loop][qtywidth][]'>
									...
									<th >
									   <input  type='text' class='form-control'  	 value='$dt_spk->keterangan' 	 id='used_keterangan_$i$loop' required name='dt[$i$loop][keterangan][]' readonly>
									</th>
									<th >
									<select id='used_slitting_$i$loop'  name='dt[$i$loop][slitting][]'> class='form-control select2' required>";
									
									if($dt_spk->slitting=='Y'){
        ...
        <tr class='bg-green'>
		  ...
		  <tr>
            ...
            <td  width='15%'><input type='hidden' class='form-control' id='lfinishgood' value=<?= $tr_spk->lfinishgood?> required name='lfinishgood' readonly ></td>
            <td width='15%'>
			<input type='text' class='form-control' value=<?= $tr_spk->bfinishgood?>  id='bfinishgood' onkeyup required name='bfinishgood' readonly >
			</td>
		 ...
		 <tr>
            ...
            <td width='15%'><input type='text' class='form-control' id='lsisa_aktual' value=<?= $tr_spk->lsisa_aktual?>  onkeyup required name='lsisa_aktual'  ></td>
            <td width='15%'>
			<input type='text' class='form-control' value=<?= $tr_spk->bsisa_aktual?>  id='bsisa_aktual' onkeyup required name='bsisa_aktual'  >
			</td>
		 ...
		 <tr>
            ...
            <td width='15%'><input type='hidden' class='form-control' id='lscrap_aktual' value=<?= $tr_spk->lscrap_aktual?>   onkeyup required name='lscrap_aktual'>
			<input type='text' class='form-control' id='coil_scrap' name='coil_scrap'  value=<?= $tr_spk->coil_scrap?>Placeholder="Qty Coil Scrap" ></td>
            <td width='15%'><input type='text' class='form-control' id='bscrap_aktual' value=<?= $tr_spk->bscrap_aktual?>  onkeyup required name='bscrap_aktual'  ></td>
            
        </tr>
	    <tr>
            <td width='7%'>4.</td>
            <td width='15%'>NG Internal</td>
            <td width='15%'><input type='text' class='form-control autoNumeric' name='ngin_lebar[]' placeholder='Lebar' ></td>
            <td width='15%'><input type='text' class='form-control autoNumeric BeratAuto' name='ngin_berat[]' value=<?= $tr_spk->berat_ng_in?>  placeholder='Berat' ></td>
            
        </tr>
		<tr>
            <td width='7%'>5.</td>
            <td width='15%'>NG Eksternal</td>
            <td  width='15%'><input type='text' class='form-control autoNumeric' name='ngek_lebar[]' placeholder='Lebar' ></td>
            <td width='15%'><input type='text' class='form-control autoNumeric BeratAuto' name='ngek_berat[]' value=<?= $tr_spk->berat_ng_ek?>  placeholder='Berat' ></td>
		...
		<tr>
            ...
            <td width='15%'></td>
            <td width='15%'><input type='text' class='form-control tweightslitting' name='tweightslitting'  id='tweightslitting' value=<?= $tr_spk->tweightslitting?>  ></td>
	...
	<div class="form-group row" >
        ...
        <tr class='bg-blue'>
		 ...
		 <?php
		 $id_spk = substr($this->uri->segment(4),0,8);
		 ...
		 $caripanjang = $this->db->query("SELECT sum(a.weight) as total FROM dt_spk_produksi as a WHERE a.id_tr_spk_produksi='$id_tr' ")->row();
		 
		 ?>
		 <tr> 
            <td width='7%'><?= $nomor ?></td>
            <td width='10%'>
			<input type='text' class='form-control' value="<?=$proses->width ?>" id='mothercoil' onkeyup required name='mothercoil' readonly >
			</td>
            <td width='10%'>
			<input type='text' class='form-control' value="<?=$proses->planning_proses_width ?>" id='produksi' onkeyup required name='produksi' readonly >
			</td>
			<td width='10%'>
			<input type='text' class='form-control' value="<?=$proses->width - $proses->lpegangan -$proses->planning_proses_width ?>" id='sisawidth' onkeyup required name='sisawidth' readonly >
			</td>
	...
	<div class="form-group row" >
        ...
        <tr class='bg-blue'>
			...
			<td width='15%'>Persentase</td>
           
         </tr>
		 <tr>
            <td width='7%'>Packing list</td>
			 <td width='15%'>
			<input type='text' class='form-control bpackinglist' value=<?= $tr_spk->bpackinglist?> id='bpackinglist' onkeyup required name='bpackinglist' readonly >
			</td>
            <td width='15%'><input type='text' class='form-control bfinishgood2' value=<?= $tr_spk->bfinishgood2?> id='bfinishgood2' onkeyup required name='bfinishgood2' readonly ></td>
            <td width='15%'>
			<input type='text' class='form-control bpackinglistselisih' value=<?= $tr_spk->bpackinglistselisih?> id='bpackinglistselisih' onkeyup required name='bpackinglistselisih' readonly >
			</td>
			<td width='15%'>
			<input type='text' class='form-control bpackinglistselisihpersen' value=<?= $tr_spk->bpackinglistselisihpersen?> id='bpackinglistselisihpersen' onkeyup required name='bpackinglistselisihpersen' readonly >
			</td>
            
         </tr>
		 <tr>
            <td width='7%'>Actual mother coil</td>
			<td width='15%'><input type='text' class='form-control baktualmother' id='baktualmother' value=<?= $tr_spk->baktualmother?> onkeyup required name='baktualmother' readonly  ></td>
            <td width='15%'><input type='text' class='form-control bfinishgood3' value=<?= $tr_spk->bfinishgood3?> id='bfinishgood3' onkeyup required name='bfinishgood3' readonly ></td>
            <td width='15%'><input type='text' class='form-control baktualmotherselisih' id='baktualmotherselisih' value=<?= $tr_spk->baktualmotherselisih?> onkeyup required name='baktualmotherselisih' readonly  ></td>
			<td width='15%'><input type='text' class='form-control baktualmotherselisihpersen' id='baktualmotherselisihpersen' value=<?= $tr_spk->baktualmotherselisihpersen?> onkeyup required name='baktualmotherselisihpersen' readonly  ></td>
            
        </tr>
	    <tr>
            <td width='7%'><b>Selisih Packing list VS Aktual</b></td>
		...
		<tr hidden>
            ...
            <td width='15%'><input type='text' class='form-control' id='baktualweight_proses' value=<?= $tr_spk->baktualweight_proses?> onkeyup required name='baktualweight_proses' readonly ></td>
            
        </tr>
		<tr hidden>
            <td width='7%'>2.</td>
            <td width='15%'>Sisa Mother Coil</td>
            <td width='15%'><input type='text' class='form-control' id='sisa_aktualweight_proses' value=<?= $tr_spk->sisa_aktualweight_proses?> onkeyup required name='sisa_aktualweight_proses' readonly ></td>
	...
	<div class="col-sm-12">
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="beda">
				<input type='hidden' class='form-control difference' id='difference' value=<?= number_format($tr_spk->difference,2)?> name='difference' readonly >
			</div>
			</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="bedapercent">
				<input type='hidden' class='form-control differencepercent' id='differencepercent' value=<?= number_format($tr_spk->differencepercent,2)?> name='differencepercent' readonly >
			</div>
			</div>
		</div>
		...
		<div class="col-sm-6">
			<div class="form-group row">
				...
				<div class="col-md-8" id="selisih">
				<input type='hidden' class='form-control balance' id='balance' value=<?= number_format($tr_spk->balance,2)?> name='balance' readonly >
			</div>
			</div>
		</div>
		</div>
