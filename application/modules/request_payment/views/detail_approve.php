						...
						foreach ($details as $dtl) : $n++;
							if ($type == 'expense') :
								...
								<tr>
									...
									<td class="text-right"><?= number_format($harga * $dtl->qty); ?></td>
							...
							<?php elseif ($type == 'nonpo') :
								...
								<tr>
									...
									<td><?= $dtl->tgl_pr; ?></td>
									<td>1</td>
									<td class="text-right"><?= number_format($dtl->nilai_satuan_request); ?></td>
									<td class="text-right"><?= number_format($dtl->total_request); ?></td>
									<td class="text-center"><a href="#" target="_blank"><i class="fa fa-download"></i></a></td>
									<td>
										<?php if ($dtl->status == '0') : ?>
											<input type="checkbox" checked value="<?= $dtl->id; ?>" name="item[<?= $n; ?>][id]" class="check_item" id="check_<?= $dtl->id; ?>">
										<?php elseif ($dtl->status == '1') : ?>
							...
							<?php elseif ($type == 'periodik') :
								...
								<tr>
									...
									<td><?= $dtl->tanggal; ?></td>
									<td>1</td>
									<td class="text-right"><?= number_format($dtl->nilai); ?></td>
									<td class="text-right"><?= number_format($dtl->nilai); ?></td>
									<td class="text-center"><a href="#" target="_blank"><i class="fa fa-download"></i></a></td>
									<td>
										<?php if ($dtl->status == '0') : ?>
						...
						$.ajax({
							...
							success: function(msg) {
								if (msg['save'] == '1') {
									...
									location.href = siteurl + active_controller + 'list_approve';
								} else {
									swal({
										title: "Gagal!",
