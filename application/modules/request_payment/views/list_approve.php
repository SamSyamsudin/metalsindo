						...
						foreach ($data as $record) {
							...
							<tr class="trows rowshow<?= $rows ?> hidden">
								...
								<td>
									...
									<?php }
									if ($ENABLE_MANAGE) : ?>
										<div class="text-center"><a href="<?= base_url($this->uri->segment(1) . '/approval_payment/?type=' . $record->tipe . '&id=' . $record->ids.'&nilai='.$record->jumlah); ?>" name="save" class="btn btn-primary btn-sm"><i class="fa fa-check-square-o">&nbsp;</i>Approve</a></div>
