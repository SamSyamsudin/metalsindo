...
//        $this->auth->restrict($this->viewPermission);
	...
	public function kompilasi(){
		$group_header = $this->db->query("SELECT a.department, a.costcenter, b.nama AS nm_dept, c.cost_center FROM budget_rutin_header a join ms_department b on a.department=b.id left join department_center c on a.costcenter=c.id GROUP BY a.department,a.costcenter, b.nama, c.cost_center")->result_array();
