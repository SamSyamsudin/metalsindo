        ...
        <!-- Biodata Mitra -->
            ...
            <?= form_open($this->uri->uri_string(),array('id'=>'frm_data','name'=>'frm_data','role'=>'form','class'=>'form-horizontal')) ?>
				...
				<div class="form-group row">
					<div class="col-md-2 text-bold">Departement <font size="4" color="red"><B>*</B></font></div>
					<div class="col-md-3">
						<?php
					...
					foreach($data_detail as $key){
					  ...
					  if($key->id_barang!='') {
						  ...
						  <tr>
							...
							<td class="text-center"><input type="hidden" name="satuan[]" value="'.$key->satuan.'">'.$key->nm_satuan.'</td>
