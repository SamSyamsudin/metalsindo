...
<script type="text/javascript">
	...
	function cariSelisih(id,no){
		...
		$("#dt_selisih_"+id+"_"+no).val(number_format(selisih*-1,2));
	...
	function customerSelect(id,no){
		var gudang = $("#dt_gudang_"+id+"_"+no).val();
		
		console.log(gudang);
		
		if(gudang!=3){
		$("#dt_customer_"+id+"_"+no).attr("disabled","disabled");
		}
		else{
		$("#dt_customer_"+id+"_"+no).removeAttr("disabled");
		}
	}
